...
This directory contains projects and exercises related to the course **Introduction to Computer Programming**. The purpose of these projects is to apply the concepts learned in this course to real-world scenarios, reinforcing knowledge and skills.
