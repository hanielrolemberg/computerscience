# Web Development in HTML5 CSS JavaScript

This directory contains projects and exercises related to the course **Web Development in HTML5 CSS JavaScript**. The purpose of these projects is to apply the concepts learned in this course to real-world scenarios, reinforcing knowledge and skills.
