# Cloud IoT and Industry 4.0 Applications

This directory contains projects and exercises related to the course **Cloud IoT and Industry 4.0 Applications**. The purpose of these projects is to apply the concepts learned in this course to real-world scenarios, reinforcing knowledge and skills.
